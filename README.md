...
| Name | Description|
|------|------------|
| Platforms | <ul><li>Windows</li><li>Linux</li><li>MacOS (partial)</li><li>Android</li><li>NativeAOT support</li></ul>
...
| Rendering | <ul><li>Forward rendering using SDL GPU</li><li>Custom shader format with support for variants, variant dependencies, using [slang](https://shader-slang.org/)</li><li>Shaders and Compute Shaders</li><li>Material system with support for toggling variants based on parameters being set</li><li>Culling Volumes for culling parts of the world efficiently</li><li>Spatial hashing for better large object count performance</li><li>Render Queues for sorting and managing batches for rendering</li></ul> |
...
| Meshes | <ul><li>Supports loading GLTF/GLB, FBX, and OBJ</li><li>Skeletal animation/skinning</li><li>Blendshapes</li><li>Instancing</li><li>Mesh Simplification</li><li>Mesh Combine at runtime</li><li>Multidraw of non-skinned meshes</li></ul> |
