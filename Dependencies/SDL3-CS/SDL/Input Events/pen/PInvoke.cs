...
public static partial class SDL
{
    ...
    /// <para>Many platforms do not supply this information, so an app must always be
    /// prepared to get an <see cref="PenDeviceType.Unknown"/> result.</para>
    /// </summary>
    /// <param name="instanceId">the pen instance ID.</param>
    /// <returns>the device type of the given pen, or <seealso cref="PenDeviceType.Invalid"/>
