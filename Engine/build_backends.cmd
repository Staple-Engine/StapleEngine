...
dotnet build "Core/StapleCore.csproj" -c Debug -o "../Staging/Player Backends/iOS/Runtime/Debug" /p:TargetFramework=net8.0-ios15.0
...
dotnet build "Core/StapleCore.csproj" -c Release -o "../Staging/Player Backends/iOS/Runtime/Release" /p:TargetFramework=net8.0-ios15.0
...
dotnet build "StapleJoltPhysics/StapleJoltPhysics.csproj" -c Debug -o "../Staging/Player Backends/iOS/Modules/Debug" /p:TargetFramework=net8.0-ios15.0
...
dotnet build "StapleJoltPhysics/StapleJoltPhysics.csproj" -c Debug -o "../Staging/Player Backends/iOS/Modules/Release" /p:TargetFramework=net8.0-ios15.0
...
dotnet build "StapleOpenALAudio/StapleOpenALAudio.csproj" -c Debug -o "../Staging/Player Backends/iOS/Modules/Debug" /p:TargetFramework=net8.0-ios15.0
...
dotnet build "StapleOpenALAudio/StapleOpenALAudio.csproj" -c Release -o "../Staging/Player Backends/iOS/Modules/Release" /p:TargetFramework=net8.0-ios15.0
