...
public class MacOSBuildProcessor : IBuildPostprocessor
{
    public BuildProcessorResult OnPostprocessBuild(BuildInfo buildInfo)
    {
        ...
        StorageUtils.CreateDirectory(appPath);
        StorageUtils.CreateDirectory(Path.Combine(appPath, "Contents"));
        StorageUtils.CreateDirectory(Path.Combine(appPath, "Contents", "MacOS"));
        StorageUtils.CreateDirectory(Path.Combine(appPath, "Contents", "MacOS", "Data"));
