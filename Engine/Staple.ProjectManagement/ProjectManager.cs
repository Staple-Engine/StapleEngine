...
public partial class ProjectManager
{
        ...
        Dictionary<string, string> asmDefProperties, AppSettings projectAppSettings, AppPlatform platform, ProjectGenerationFlags flags)
    {
        ...
        var playerSupportPath = Path.Combine(backend.basePath, "Runtime", configurationName, $"Staple.Player.{platform}.dll");
        ...
        if(flags.HasFlag(ProjectGenerationFlags.IsPlayer))
        {
            ...
            p.AddItem("Reference", $"Staple.Player.{platform}",
                [
                    new("HintPath", Path.Combine(backend.basePath, "Runtime", configurationName, playerSupportPath))
                ]);
