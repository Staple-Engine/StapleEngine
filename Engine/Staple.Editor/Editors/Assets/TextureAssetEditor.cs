...
internal class TextureAssetEditor : AssetEditor
{
        ...
        EditorGUI.Button("Apply to all in folder", "TextureMetadataApplyAll", () =>
        {
            try
            {
                ...
                foreach (var file in files)
                {
                    ...
                    if (texture != null)
                    {
                        var json = JsonConvert.SerializeObject(newMetadata, Formatting.Indented, Staple.Tooling.Utilities.JsonSettings);
