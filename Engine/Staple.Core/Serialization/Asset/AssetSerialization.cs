...
public static partial class AssetSerialization
{
    ...
    public static int GetTextureElementSize(TextureFormat format)
    {
        return format switch
        {
    ...
    public static int GetTextureElementSize(TextureMetadataFormat format)
    {
        return format switch
        {
            TextureMetadataFormat.R8 => sizeof(byte),
            TextureMetadataFormat.R8I => sizeof(byte),
            TextureMetadataFormat.R8U => sizeof(byte),
            TextureMetadataFormat.R8S => sizeof(byte),
            TextureMetadataFormat.R16 => sizeof(ushort),
            TextureMetadataFormat.R16I => sizeof(ushort),
            TextureMetadataFormat.R16U => sizeof(ushort),
            TextureMetadataFormat.R16F => sizeof(ushort),
            TextureMetadataFormat.R16S => sizeof(ushort),
            TextureMetadataFormat.RG8 => sizeof(ushort),
            TextureMetadataFormat.RG8I => sizeof(ushort),
            TextureMetadataFormat.RG8U => sizeof(ushort),
            TextureMetadataFormat.RG8S => sizeof(ushort),
            TextureMetadataFormat.RG16 => sizeof(uint),
            TextureMetadataFormat.RG16I => sizeof(uint),
            TextureMetadataFormat.RG16U => sizeof(uint),
            TextureMetadataFormat.RG16F => sizeof(uint),
            TextureMetadataFormat.RG16S => sizeof(uint),
            TextureMetadataFormat.BGRA8 => sizeof(uint),
            TextureMetadataFormat.RGBA8 => sizeof(uint),
            TextureMetadataFormat.RGBA8I => sizeof(uint),
            TextureMetadataFormat.RGBA8U => sizeof(uint),
            TextureMetadataFormat.RGBA8S => sizeof(uint),
            TextureMetadataFormat.RGBA16 => sizeof(ulong),
            TextureMetadataFormat.RGBA16I => sizeof(ulong),
            TextureMetadataFormat.RGBA16U => sizeof(ulong),
            TextureMetadataFormat.RGBA16F => sizeof(ulong),
            TextureMetadataFormat.RGBA16S => sizeof(ulong),
            TextureMetadataFormat.B5G6R5 => sizeof(ushort),
            TextureMetadataFormat.BGRA4 => sizeof(ushort),
            TextureMetadataFormat.BGR5A1 => sizeof(ushort),
            _ => 0,
        };
    }
}
